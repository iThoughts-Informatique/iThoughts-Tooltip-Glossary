...
r.parentElement.scrollTop>p-50&&(r.parentElement.scrollTop=r.parentElement.scrollHeight),n.data.progression<o.max?t(n.data.progression):(ithoughts_tt_gl_updater.from=o.targetversion,jQuery.post(ithoughts_tt_gl.admin_ajax,{action:"ithoughts_tt_gl_update_done",data:{newversion:ithoughts_tt_gl_updater.from}},function(t){t.success&&e(ithoughts_tt_gl_updater)}))})}function e(e){console.log("Init step update",e),$.post(ithoughts_tt_gl.admin_ajax,{action:"ithoughts_tt_gl_update",data:{versions:e,progression:-1,maxAdvandement:-1}},function(e){var n=$("#ithoughts_tt_gl_updater")
