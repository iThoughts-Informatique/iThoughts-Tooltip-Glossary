...
$(e).append($(t))
var e=e.html()
return e}function e(e){for(var i=$win.height(),s=$win.width(),o=0,a=[[512,288],[256,144]],n=a.length;n>o&&!(s>a[o][0]&&i>a[o][1]);o++);var r=a[o]
...
$win.resize(function(){clearTimeout(i),i=setTimeout(e,100)}),$doc.ready(function(){tooltipsContainer=$($.parseHTML('<div id="ithoughts_tooltip_glossary-tipsContainer"></div>')),$(document.body).append(tooltipsContainer)
...
h={content:{text:"Loading glossary term",ajax:{url:ithoughts_tt_gl.admin_ajax,type:"POST",data:g,dataType:"json",loading:!1,success:function(t,e){t.success?(this.set("content.title",t.data.title),this.set("content.text",t.data.content)):this.set("content.text","Error")}},title:{text:"Please wait"}},style:{classes:d+"ithoughts_tooltip_glossary-glossary"}}}else this.getAttribute("data-term-content")&&this.getAttribute("data-term-title")&&(h={content:{title:{text:this.getAttribute("data-term-title")},text:this.getAttribute("data-term-content")},style:{classes:d+"ithoughts_tooltip_glossary-glossary"}})
