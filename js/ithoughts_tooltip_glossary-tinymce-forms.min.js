!function(){$doc.ready(function(){function t(t){try{tinymce.EditorManager.execCommand("mceRemoveEditor",!0,t)}catch(e){console.warn("Force cleaning needed: ",e),tinymce.EditorManager.editors=tinymce.EditorManager.editors.filter(function(e){return e.id!=t})}}function e(){n.offset().top,$win.height()+$win.scrollTop()}function i(){n.find("*:focus")||o.is(":focus")||n.addClass("hidden")}function a(){var t=[],a=[]
