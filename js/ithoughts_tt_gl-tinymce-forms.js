...
(function(){
    $d.ready(function(){
        ...
        /**
         * @function switchTab
         * @description Set the visible tab container according to the header clicked
         * @author Gerkin
         * @param {ClickEvent} event Click event on '.tabs li'
         */
        $('.tabs li').click(function switchTab(event){
            if($(this).hasClass('active')){
                return;
            }
            $(this).parent().find('.active').removeClass('active');
         ...
         * @description Use wp.media to open the media selector to define the image/video/audio of the tooltip
         * @author Gerkin
         */
        $("#ithoughts_tt_gl_select_image").click(function openMediaSelector() {
            onclickEntryPoint = this;
        ...
        // Autocomplete for glossary term
        {
            ...
            $("#ithoughts_tt_gl-tinymce-advancedOptions").click(function(){
                $("#ithoughts_tt_gl-tooltip-form-options").css({display:"block"});
            });
            $("#ithoughts_tt_gl-tinymce-options-validate").click(function(){
                $("#ithoughts_tt_gl-tooltip-form-options").css({display:"none"});
                // And get form values
                var advancedOptionsForm = gei("ithoughts_tt_gl-advancedOptions-form");
                console.log(advancedOptionsForm);
            });
            $("#ithoughts_tt_gl-tinymce-options-discard").click(function(){
                $("#ithoughts_tt_gl-tooltip-form-options").css({display:"none"});
            });
            /*$("#kv-pair-link-attrs-add").click(function(){
                $("#kv-pair-link-attrs").append($.parseHTML(ithoughts_tt_gl.kvpair.replace(/%NAME%/g, "link")));
            });
            $("#kv-pair-span-attrs-add").click(function(){
                $("#kv-pair-span-attrs").append($.parseHTML(ithoughts_tt_gl.kvpair.replace(/%NAME%/g, "span")));
            });*/
        }
        ...
        // Init attrs adders
        {
            ...
            elems.forEach(function(elem){
                $("#kv-pair-"+elem+"-attrs-add").click((function(){
                    var targetContainer = $("#kv-pair-"+elem+"-attrs")
                    return function(){
                        var newElem = ithoughts_tt_gl.kvpair.replace(/%NAME%/g,elem);
                        newElem = $($.parseHTML(newElem));
                        newElem.find(".kv-delete").click(function(){
                            newElem.remove();
                        });
                        targetContainer.append(newElem);
                    };
