...
<div id="ithoughts_tt_gl-tooltip-form-container">
    ...
    <div id="pseudohead">
        <link rel="stylesheet" id="ithoughts_tooltip_glossary-tinymce_form-css" href="<?php echo Backbone::get_instance()->get_base_url(); ?>/css/ithoughts_tooltip_glossary-tinymce-forms.css" type="text/css" media="all">
        ...
        <script type="text/javascript" src="<?php echo Backbone::get_instance()->get_base_url(); ?>/js/ithoughts_tooltip_glossary-tinymce-forms.js" defer></script>
    </div>
                                            ...
                                            <tr> 
                                                <td> 
                                                    <label for="qtip-keep-open"> 
                                                        <?php nl2br(_e("Keep tip opened
                                                        once displayed", 'ithoughts-tooltip-glossary' )); ?> 
                                                    </label> 
                                                </td> 
                                                <td> 
                                                            ...
                                                            <div> 
                                                                <div>
                                                                    <div class="ithoughts-attrs-container" data-attr-family="span">
                                                                        <div class="attribute-name-val ithoughts-prototype">
                                                                            <div class="kv-pair"> 
                                                                                <label for="attributes-span-key"> 
                                                                                    <?php _e("Key", 'ithoughts-tooltip-glossary' ); ?> 
                                                                                </label> 
                                                                                <input type="text" required autocomplete="off" list="attributes-list" name="attributes-span-key[]" id="attributes-span-key" /> 
                                                                            </div> 
                                                                            <div class="kv-pair"> 
                                                                                <label for="attributes-span-value"> 
                                                                                    <?php _e("Value", 'ithoughts-tooltip-glossary' ); ?> 
                                                                                </label> 
                                                                                <input type="text" required autocomplete="off" name="attributes-span-value[]" id="attributes-span-value" /> 
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="ithoughts-attrs-container" data-attr-family="link">
                                                                        <div class="attribute-name-val ithoughts-prototype">
                                                                            <div class="kv-pair"> 
                                                                                ...
                                                                                <input type="text" required autocomplete="off" list="attributes-list" name="attributes-link-key[]" id="attributes-link-key" /> 
                                                                            </div> 
                                                                            <div class="kv-pair"> 
                                                                                <label for="attributes-link-value"> 
                                                                                    <?php _e("Value", 'ithoughts-tooltip-glossary' ); ?> 
                                                                                </label> 
                                                                                <input type="text" required autocomplete="off" name="attributes-link-value[]" id="attributes-link-value" /> 
                                                                            </div> 
                                                                        </div>
                                                                    </div>
                                                                    <div style="clear:both;"></div> 
