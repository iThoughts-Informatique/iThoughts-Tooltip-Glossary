...
<div id="ithoughts_tt_gl-tooltip-form-container">
    ...
    <div id="pseudohead">
        ...
        <script>ithoughts_tt_gl.kvpair = '<div class="kv"><div class="kv-inputs"><div class="kv-pair"><label for="attributes-%NAME%-key"><?php _e("Key", 'ithoughts-tooltip-glossary' ); ?></label><input type="text" autocomplete="off" list="attributes-list" name="attributes-%NAME%-key" id="attributes-%NAME%-key" /></div><div class="kv-pair"><label for="attributes-%NAME%-value"><?php _e("Value", 'ithoughts-tooltip-glossary' ); ?></label><input type="text" autocomplete="off" name="attributes-%NAME%-value" id="attributes-%NAME%-value" /></div></div><button class="kv-delete mce-btn">X</button></div>'</script>
    </div>
    ...
    <div aria-label="<?php _e("Tooltip options", 'ithoughts-tooltip-glossary' ); ?>" role="dialog" style="border-width: 1px; z-index: 9999999; display:none" class="mce-container mce-panel mce-floatpanel mce-window mce-in" hidefocus="1" id="ithoughts_tt_gl-tooltip-form-options"> 
        <div class="mce-reset" role="application"> 
            ...
            <div class="mce-container-body mce-window-body"> 
                <div class="mce-container mce-form mce-first mce-last"> 
                    <div class="mce-container-body" style="height: 100%;"> 
                        <form id="ithoughts_tt_gl-advancedOptions-form"> 
                            <div style="padding:10px;flex:0 0 auto;"> 
