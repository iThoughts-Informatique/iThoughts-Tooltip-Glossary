					...
					<div style="display:flex;flex-direction:row;flex-wrap:wrap;">
						<div id="normal-sortables" class="" style="flex:1 1 auto;"><!--Old removed classes: "meta-box-sortables ui-sortable"-->
							<div class="postbox">
								...
								<div class="inside">
									<form id="ithoughts_loadtheme" method="get">
										...
										<button type="submit" class="button button-secondary" name="action" value="delete"
												onclick="var themename=gei('themename');return ((themename&&themename.value&&(themename=themename.value))?confirm('<?php
														 /* translators: %s is the url to the documentation in current language (if available) */
														 esc_attr_e( 'Are you sure you want to delete the theme %s?', 'ithoughts-tooltip-glossary' ); ?>'.replace('%s', themename)):false);"><?php esc_html_e( 'Delete', 'ithoughts-tooltip-glossary' ); ?></button>
									</form>
								</div>
							</div>
							...
							<div class="postbox" id="ithoughts-tt-gl-lesseditor">
								<h3 class="hndle"><span><?php esc_html_e( 'LESS editor', 'ithoughts-tooltip-glossary' ); ?></span></h3>
								<div class="inside">
									<form id="LESS-form" class="less-form simpleajaxform" action="<?php echo esc_url( admin_url( 'admin-ajax.php' ) ); ?>" method="post" data-target="update-response">
										...
										<table class="form-table stripped">
											<tr>
												<th><?php esc_html_e( 'Theme name', 'ithoughts-tooltip-glossary' ); ?></th>
												<td><?php
											...
											<tr>
												<td colspan="2">
													<div>
														<button name="actionB" value="ithoughts_tt_gl_theme_save" id="compilecss" class="alignleft button button-primary" style="display:inline-block;width:50%;text-align:center;"><?php esc_html_e( 'Save theme', 'ithoughts-tooltip-glossary' ); ?></button>
														<button name="actionB" value="ithoughts_tt_gl_theme_preview" id="previewcss" class="alignleft button" style="display:inline-block;width:50%;text-align:center;"><?php esc_html_e( 'Preview', 'ithoughts-tooltip-glossary' ); ?></button>
													</div>
												</td>
											</tr>
											<tr>
