<?php
/**
 * Generates the script that defines our animation functions
 *
...
if ( count( $anims_custom_in ) > 0 || count( $anims_custom_out ) > 0 ) {
	echo '<script id="ithoughts_tt_gl-custom-anims">iThoughtsTooltipGlossary.animationFunctions = jQuery.extend(!0,iThoughtsTooltipGlossary.animationFunctions,{';
