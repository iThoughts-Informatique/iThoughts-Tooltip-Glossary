...
?> <div id="ithoughts_tt_gl-tooltip-form-container"><div id="pseudohead"><link rel="stylesheet" id="ithoughts_tt_gl-tinymce_form-css" href="<?php echo esc_url( Backbone::get_instance()->get_resource( 'ithoughts_tooltip_glossary-tinymce_form-css' )->get_file_url() ); ?>" type="text/css" media="all"><script type="text/javascript" src="<?php echo esc_url( Backbone::get_instance()->get_resource( 'ithoughts-simple-ajax-v5' )->get_file_url() ); ?>" defer="defer"></script><script type="text/javascript" src="<?php echo esc_url( Backbone::get_instance()->get_resource( 'ithoughts_tooltip_glossary-tinymce_form' )->get_file_url() ); ?>?v=3.0.1" defer="defer"></script><script type="text/javascript" src="<?php echo esc_url( Backbone::get_instance()->get_resource( 'ithoughts_tooltip_glossary-qtip' )->get_file_url() ); ?>" defer="defer"></script><script>iThoughtsTooltipGlossaryEditor.terms = <?php echo wp_json_encode( $terms ); ?>;</script></div><div aria-label="<?php esc_html_e( 'Insert a Tooltip', 'ithoughts-tooltip-glossary' ); ?>" role="dialog" style="border-width: 1px; z-index: 100101" class="itg-panel itg-floatpanel itg-window itg-in" hidefocus="1" id="ithoughts_tt_gl-tooltip-form"><div class="itg-reset" role="application"><div class="itg-window-head"><div class="itg-title"> <?php esc_html_e( 'Insert a Tooltip', 'ithoughts-tooltip-glossary' ); ?> </div><button aria-hidden="true" class="itg-close ithoughts_tt_gl-tinymce-discard" type="button">×</button></div><div class="itg-window-body"><div class="itg-form itg-first itg-last"><div class="" style="height: 100%"><form> <?php wp_nonce_field( 'ithoughts_tt_gl-get_terms_list' ) ?> <div style="padding:10px;flex:0 0 auto"><table><tr><td><label for="itghouts_tt_gl_text"> <?php esc_html_e( 'Text', 'ithoughts-tooltip-glossary' ); ?> </label></td><td><input type="text" autocomplete="off" id="ithoughts_tt_gl_text" name="ithoughts_tt_gl_text" value="<?php echo esc_attr( $data['text'] ); ?>"></td></tr><tr><td><label for="itghouts_tt_gl_link"> <?php esc_html_e( 'Link', 'ithoughts-tooltip-glossary' ); ?> </label></td><td><input type="text" autocomplete="off" id="ithoughts_tt_gl_link" name="ithoughts_tt_gl_link" <?php
										...
										?> <tr><td><label for="glossary_term"> <?php esc_html_e( 'Term', 'ithoughts-tooltip-glossary' ); ?> </label></td><td><input autocomplete="off" type="text" id="glossary_term" name="glossary_term" value="<?php echo esc_attr( (isset( $data['term_title'] )) ? $data['term_title'] : $data['term_search'] ); ?>" class="completed"><div class="glossary_term_completer_container" class="hidden"><div id="glossary_term_completer" class="completer"></div></div><input type="hidden" name="glossary_term_id" value="<?php echo esc_attr( $data['glossary_id'] ); ?>"></td></tr> <?php
										if ( function_exists( 'icl_object_id' ) ) {
										?> <tr><td><label for="glossary_disable_auto_translation"> <?php esc_html_e( 'Disable<br/>auto-translation', 'ithoughts-tooltip-glossary' ); ?> </label></td><td><input type="checkbox" id="glossary_disable_auto_translation" name="glossary_disable_auto_translation" value="true" <?php echo ((isset( $data['glossary_disable_auto_translation'] ) && $data['glossary_disable_auto_translation']) ? ' checked' : ''); ?>></td></tr> <?php
										}
										?> </table></div><div class="tab"><table><tr><td colspan="2"><label for="ithoughts_tt_gl-tooltip-content"> <?php esc_html_e( 'Content', 'ithoughts-tooltip-glossary' ); ?> </label><div style="margin:0 -11px"><textarea class="tinymce" id="ithoughts_tt_gl-tooltip-content"><?php echo esc_html( $data['tooltip_content'] ); ?></textarea></div></td></tr></table></div><div class="tab"><table><tr><td><label for="mediatip_type"> <?php esc_html_e( 'Mediatip type', 'ithoughts-tooltip-glossary' ); ?> </label></td><td> <?php
												echo wp_kses($inputs['mediatip_type'], array(
												...
												)); ?> </td></tr><tr data-mediatip_type="mediatip-localimage-type"><td colspan="2"><div class="image-box" id="image-box"> <?php
													...
													)); ?> </td></tr><tr><td><label for="qtip-keep-open"> <?php
													...
													)); ?> </td></tr><tr><td><label for="qtiptrigger"> <?php esc_html_e( 'Tooltip trigger', 'ithoughts-tooltip-glossary' ); ?> </label></td><td> <?php
													...
													) ); ?> </td></tr><tr><td><label for="qtipstyle"> <?php esc_html_e( 'Tooltip style', 'ithoughts-tooltip-glossary' ); ?> </label></td><td> <?php
													...
													)); ?> </td></tr><tr><td><label for="qtipshadow"> <?php esc_html_e( 'Tooltip shadow', 'ithoughts-tooltip-glossary' ); ?> </label></td><td> <?php
													...
													)); ?> </td></tr><tr><td><label for="qtiprounded"> <?php esc_html_e( 'Rounded corners', 'ithoughts-tooltip-glossary' ); ?> </label></td><td> <?php
													...
													)); ?> </td></tr><tr><td><label for="position_my"> <?php
													...
													?> <label for="position_my_invert"><?php
														...
														esc_html_e( 'Invert main axis', 'ithoughts-tooltip-glossary' ); ?></label></td></tr><tr><td><label for="position_at"> <?php
													...
													?> </td></tr><tr><td><label for="in_out"> <?php esc_html_e( 'Animations', 'ithoughts-tooltip-glossary' ); ?> </label></td><td><label for="anim[in]"><?php esc_html_e( 'In', 'ithoughts-tooltip-glossary' ); ?>:&nbsp;<?php
														...
														)); ?></label>&nbsp;&nbsp;<label for="anim[out]"><?php esc_html_e( 'Out', 'ithoughts-tooltip-glossary' ); ?>:&nbsp;<?php
														...
														)); ?></label>&nbsp;&nbsp;<label for="anim[time]"><?php esc_html_e( 'Duration', 'ithoughts-tooltip-glossary' ); ?>:&nbsp;<?php
														...
														)); ?>ms</label></td></tr><tr><td><label for="maxwidth"> <?php
													...
													)); ?> </td></tr></table></div><div class="tab"><table><tr><td colspan="2"><datalist id="attributes-list"> <?php
