...
?> <div id="ithoughts_tt_gl-list-form-container"><div id="pseudohead"><link rel="stylesheet" id="ithoughts_tt_gl-tinymce_form-css" href="<?php echo esc_url( Backbone::get_instance()->get_resource( 'ithoughts_tooltip_glossary-tinymce_form-css' )->get_file_url() ); ?>" type="text/css" media="all"><script type="text/javascript" src="<?php echo esc_url( Backbone::get_instance()->get_resource( 'ithoughts-simple-ajax-v5' )->get_file_url() ); ?>" defer="defer"></script><script type="text/javascript" src="<?php echo esc_url( Backbone::get_instance()->get_resource( 'ithoughts_tooltip_glossary-tinymce_form' )->get_file_url() ); ?>?v=3.0.1" defer="defer"></script><script type="text/javascript" src="<?php echo esc_url( Backbone::get_instance()->get_resource( 'ithoughts_tooltip_glossary-qtip' )->get_file_url() ); ?>" defer="defer"></script></div><div aria-label="<?php esc_html_e( 'Insert Glossary Index', 'ithoughts-tooltip-glossary' ); ?>" role="dialog" style="border-width: 1px; z-index: 999999" class="itg-panel itg-floatpanel itg-window itg-in" hidefocus="1" id="ithoughts_tt_gl-list-form"><div class="itg-reset" role="application"><div class="itg-window-head"><div class="itg-title"> <?php esc_html_e( 'Insert Glossary Index', 'ithoughts-tooltip-glossary' ); ?> </div><button aria-hidden="true" class="itg-close ithoughts_tt_gl-tinymce-discard" type="button">×</button></div><div class="itg-window-body"><div class="itg-form itg-first itg-last"><div class="" style="height: 100%"><form><div style="padding:10px;flex:0 0 auto"><table><tr><td><label for="letters"> <?php
											...
											) ); ?> </td></tr><tr><td><label for="groups"> <?php
											...
											echo wp_kses($inputs['groups'], array(
												...
												?> </div></td></tr></table><div class="tab-container"><ul class="tabs" role="tablist"><li class="<?php echo ('atoz' === $data['type']) ? 'active' : ''; ?>" role="tab" tabindex="-1"> <?php esc_html_e( 'A to Z', 'ithoughts-tooltip-glossary' ); ?> </li><li class="<?php echo ('list' === $data['type']) ? 'active' : ''; ?>" role="tab" tabindex="-1"> <?php esc_html_e( 'List', 'ithoughts-tooltip-glossary' ); ?> </li><li class="topLiner"></li></ul><div class="tab"> <?php esc_html_e( 'No additionnal options', 'ithoughts-tooltip-glossary' ); ?> </div><div class="tab"><table><tr><td><label for="description_mode"> <?php
													...
													)); ?> </td></tr><tr><td><label for="columns_count"> <?php
