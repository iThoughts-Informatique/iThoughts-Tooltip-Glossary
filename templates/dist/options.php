								...
								echo wp_kses( __( 'Labels in <span class=\"nonoverridable\">red</span> indicate global options, not overridable by tips.', 'ithoughts-tooltip-glossary' ), array(
									'span' => array(
										'class' => array(),
														...
														); ?> </label></th><td> <?php $options_inputs['staticterms']->do_print(); ?> </td></tr></tbody></table></div></div><div id="ithoughts_tt_gllossary_options_2" class="postbox"><div class="handlediv" title="Cliquer pour inverser."><br></div><h3 class="hndle"><span><?php esc_html_e('General options options', 'ithoughts-tooltip-glossary'); ?></span></h3><div class="inside"><table class="form-table"><tr><th><label for="<?php echo esc_attr($options_inputs['termlinkopt']->get_id()); ?>"><?php esc_html_e( 'Term link', 'ithoughts-tooltip-glossary' ); ?>:</label></th><td> <?php $options_inputs['termlinkopt']->do_print(); ?> </td></tr><tr><th><label for="<?php echo esc_attr($options_inputs['list-contenttype']->get_id()); ?>"><?php esc_html_e( 'Default list display', 'ithoughts-tooltip-glossary' ); ?>:</label></th><td> <?php $options_inputs['list-contenttype']->do_print(); ?> </td></tr><tr class="nonoverridable"><th><label for="<?php echo esc_attr($options_inputs['forceloadresources']->get_id()); ?>"><?php esc_html_e( 'Force load resources', 'ithoughts-tooltip-glossary' ); ?>&nbsp;<?php
														...
														); ?>:</label></th><td> <?php $options_inputs['forceloadresources']->do_print(); ?> </td></tr><tr class="nonoverridable"><th><label for="<?php echo esc_attr($options_inputs['use_cdn']->get_id()); ?>"><?php esc_html_e( 'Use CDN for library files', 'ithoughts-tooltip-glossary' ); ?>:</label></th><td> <?php $options_inputs['use_cdn']->do_print(); ?><p></p></td></tr><tr class="nonoverridable"><th><label for="<?php echo esc_attr($options_inputs['verbosity']->get_id()); ?>"><?php esc_html_e( 'Log level', 'ithoughts-tooltip-glossary' ); ?>&nbsp;<?php
