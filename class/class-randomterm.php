		...
		public function __construct() {
			parent::__construct(
				...
				array(
					...
					'description' => __( 'Add a random gloss to your sidebar', 'ithoughts-tooltip-glossary' ),
				)
			); // parent::__construct
		} // __construct
					...
					switch ( $display ) {
						...
						case 'tooltip':{
							...
							if ( $options['staticterms'] ) {
								...
								$content;
								switch ( $options['gloss-contenttype'] ) {
									case 'full':{
								...
								$jsdata[] = 'data-content="' . $options['gloss-contenttype'] . '"';
							}
