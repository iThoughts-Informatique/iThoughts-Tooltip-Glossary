...
if(!class_exists(__NAMESPACE__."\\Filters")){
	class Filters extends \ithoughts\v1_0\Singleton{
		public function __construct(){
			...
			add_filter("ithoughts-tt-gl_tooltip-anim-out", array(&$this, "checkAnimsInfosOut"), 10000000, 2);
			add_filter("ithoughts-tt-gl_tooltip-anim-in", array(&$this, "checkAnimsInfosIn"), 10000000, 2);
		}
