...
require_once( Backbone::get_instance()->get_base_path() . '/submodules/iThoughts-WordPress-Plugin-Toolbox/class/CssEdit.class.php' );
use \ithoughts\v1_2\Toolbox as TB;
use \ithoughts\v1_0\CssEdit as CSS;
...
<?php
	 ...
	 */
        public function theme_editor(){
            ...
            if(isset($themedata["editor_compliant"]) && !$themedata["editor_compliant"]){
?>
<div class="notice notice-warning">
    <p><?php _e( 'This file is not generated by iThoughts Tooltip Glossary theme editor! You may break this theme by editing it here...', 'ithoughts-tooltip-glossary' ); ?></p>
</div>
<?php
                                                                                        }
            ...
            $formDatas = array(
                "global" => array(
                    "box-shadow" => CSS::getForm(
                        "box-shadow",
                        array(
                            "horizontal" => array(
                                "attributes" => array(
                                    "data-pattern-infos" => __('Valid distance value: 0, inherit, initial, or a value in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax. Negatives accepted', 'ithoughts-tooltip-glossary' ),
                            ...
                            "spread" => array(
                                "attributes" => array(
                                    "data-pattern-infos" => __('Valid distance value: 0, inherit, initial, or a value in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax. Negatives not accepted', 'ithoughts-tooltip-glossary' ),
                                    "data-child-form" => "shadow-true"
                                )
                            ),
                            "blur" => array(
                    ...
                    "border" => CSS::getForm(
                        ...
                        array(
                            "width" => array(
                                "attributes" => array(
                                    "data-pattern-infos" => __('Valid border-width value: 0, inherit, initial, or a value in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax. Negatives not accepted', 'ithoughts-tooltip-glossary' )
                                )
                            )
                        ),
                        "global[border]"
            ...
            $inputs = array(
                ...
                "global" => array(
                    "background" => TB::generate_input_text("global[background]", CSS::getForm("background-color", array("value" => "#f00"), "global[background]")),
                    "box-shadow" => array(
                        "horizontal" => TB::generate_input_text("global[box-shadow][horizontal]", $formDatas["global"]["box-shadow"]["horizontal"]),
                        "vertical" => TB::generate_input_text("global[box-shadow][vertical]", $formDatas["global"]["box-shadow"]["vertical"]),
                        "blur" => TB::generate_input_text("global[box-shadow][blur]", $formDatas["global"]["box-shadow"]["blur"]),
                        "spread" => TB::generate_input_text("global[box-shadow][spread]", $formDatas["global"]["box-shadow"]["spread"]),
                        "color" => TB::generate_input_text("global[box-shadow][color]", $formDatas["global"]["box-shadow"]["color"]),
                        "inset" => TB::generate_input_check("global[box-shadow][inset]", $formDatas["global"]["box-shadow"]["inset"])
                    ),
                    "border" =>array(
                        "width" => TB::generate_input_text("global[border][width]", $formDatas["global"]["border"]["width"]),
                        "style" => TB::generate_input_select("global[border][style]", $formDatas["global"]["border"]["style"]),
                        "color" => TB::generate_input_text("global[border][color]", $formDatas["global"]["border"]["color"]),
                    ),
                    "link" => array(
                        "color" => TB::generate_input_text("global[link][color]", CSS::getForm("color", array("value" => "0"), "global[link][color]")),
                        "font-weight" => TB::generate_input_select("global[link][font-weight]", CSS::getForm("font-weight", array("value" => "0"), "global[link][font-weight]")),
                        "font-style" => TB::generate_input_select("global[link][font-style]", CSS::getForm("font-style", array("value" => "0"), "global[link][font-style]")),
                        "text-decoration" => TB::generate_input_select("global[link][text-decoration]", CSS::getForm("text-decoration", array("value" => "0"), "global[link][text-decoration]")),
                    ),
                ),
                "title" => array(
                    "background" => TB::generate_input_text("title[background]", CSS::getForm("background-color", array("value" => "#0f0"), "title[background]")),
                    "padding" => TB::generate_input_text("title[padding]", CSS::getForm("padding", array("value" => "0", "attributes" => array( "data-pattern-infos" => __('Valid padding value: 0, inherit, initial, or 1 to 4 values in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax', 'ithoughts-tooltip-glossary' ))), "title[padding]")),
                    "font-size" => TB::generate_input_text("title[font-size]", CSS::getForm("font-size", array("value" => "0", "attributes" => array( "data-pattern-infos" => __('Valid font-size value: xx-small, x-small, smaller, small, medium, large, larger, x-large, xx-large, or a value in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax', 'ithoughts-tooltip-glossary' ))), "title[font-size]")),
                    "line-height" => TB::generate_input_text("title[line-height]", CSS::getForm("line-height", array("value" => "0", "attributes" => array( "data-pattern-infos" => __('Valid line-height value: xx-small, x-small, smaller, small, medium, large, larger, x-large, xx-large, or a value in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax', 'ithoughts-tooltip-glossary' ))), "title[line-height]")),
                    "color" => TB::generate_input_text("title[color]", CSS::getForm("color", array("value" => "0"), "title[color]")),
                    "font-weight" => TB::generate_input_select("title[font-weight]", CSS::getForm("font-weight", array("value" => "0"), "title[font-weight]")),
                    "font-style" => TB::generate_input_select("title[font-style]", CSS::getForm("font-style", array("value" => "0"), "title[font-style]")),
                    "text-decoration" => TB::generate_input_select("title[text-decoration]", CSS::getForm("text-decoration", array("value" => "0"), "title[text-decoration]")),
                    "text-align" => TB::generate_input_select("title[text-align]", CSS::getForm("text-align", array("value" => "0"), "title[text-align]")),
                    "font-family" => TB::generate_input_select("title[font-family]", array("options"=>array(""=>__('Please wait...', 'ithoughts-tooltip-glossary' ))),"title[font-family]")
                ),
                "content" => array(
                    "background" => TB::generate_input_text("content[background]", CSS::getForm("background-color", array("value" => "#00f"), "content[background]")),
                    "padding" => TB::generate_input_text("content[padding]", CSS::getForm("padding", array("value" => "0", "attributes" => array( "data-pattern-infos" => __('Valid padding value: 0, inherit, initial, or 1 to 4 values in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax', 'ithoughts-tooltip-glossary' ))), "content[padding]")),
                    "font-size" => TB::generate_input_text("content[font-size]", CSS::getForm("font-size", array("value" => "0", "attributes" => array( "data-pattern-infos" => __('Valid font-size value: xx-small, x-small, smaller, small, medium, large, larger, x-large, xx-large, or a value in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax', 'ithoughts-tooltip-glossary' ))), "content[font-size]")),
                    "line-height" => TB::generate_input_text("content[line-height]", CSS::getForm("line-height", array("value" => "0", "attributes" => array( "data-pattern-infos" => __('Valid line-height value: xx-small, x-small, smaller, small, medium, large, larger, x-large, xx-large, or a value in rem, em, px, %, ex, pt, cm, mm, in, pc, vh, vw, vmin, or vmax', 'ithoughts-tooltip-glossary' ))), "content[line-height]")),
                    "color" => TB::generate_input_text("content[color]", CSS::getForm("color", array("value" => "0"), "content[color]")),
                    "font-weight" => TB::generate_input_select("content[font-weight]", CSS::getForm("font-weight", array("value" => "0"), "content[font-weight]")),
                    "font-style" => TB::generate_input_select("content[font-style]", CSS::getForm("font-style", array("value" => "0"), "content[font-style]")),
                    "text-decoration" => TB::generate_input_select("content[text-decoration]", CSS::getForm("text-decoration", array("value" => "0"), "content[text-decoration]")),
                    "text-align" => TB::generate_input_select("content[text-align]", CSS::getForm("text-align", array("value" => "0"), "content[text-align]")),
                    "font-family" => TB::generate_input_select("content[font-family]", array("options"=>array(""=>__('Please wait...', 'ithoughts-tooltip-glossary' ))),"content[font-family]")
                ),
            );
        ...
        private function loadtheme($themename = NULL){
            ...
            */
            ...
            $themedata["global"]["background"] = "#fff";

            if($themename != NULL){ // Parse only if we have a theme name
                ...
                if(file_exists($themeInfos["absdir"]."/".$reformatedThemeName.".less")){
                    // Prepare regex helpers
                    $regexes;
                    {
                        $regexes = array(
                    ...
                    $themedata["editor_compliant"] = preg_match("/^\\/* This file is compatible with the Theme Editor *\\/", $content);
                    $regexAttr = "/^@box-shadow:\s*?(?P<h>{$regexes["sizen"]})\s+(?P<v>{$regexes["sizen"]})\s+(?P<blur>{$regexes["size"]})\s+(?P<spread>{$regexes["size"]})\s+(?P<color>{$regexes["color"]})(\s+(?P<inset>inset))?{$regexes["eol"]}/m";
                    $matched = preg_match($regexAttr,$content, $matches);
                    var_dump(htmlentities($regexAttr), $matches);
                    if($matched === 1){
                    ...
                    $regexAttr = "/^@border:\s*?(?P<w>{$regexes["size"]})\s+(?P<type>dotted|solid|dashed|double|groove|ridge|inset|outset|none|hidden)\s+(?P<color>{$regexes["color"]}){$regexes["eol"]}/m";
                    $matched = preg_match($regexAttr,$content, $matches);
                    var_dump(htmlentities($regexAttr), $matches);
                    if($matched === 1){
        ...
        private function theme_to_less($theme){
            ...
            foreach($types as $type => $Type){
                ...
                if($Type == "global")
                    ...
                    // Filter childs to allow them inherit from global properties
