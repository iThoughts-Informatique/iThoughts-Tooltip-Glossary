...
if(!class_exists(__NAMESPACE__."\\Backbone")){
	class Backbone extends \ithoughts\v2_0\Backbone{
		...
		public function register_scripts_and_styles(){
			...
			wp_register_script( 'ithoughts_tooltip_glossary-qtip',  $this->base_url . '/js/ithoughts_tt_gl-qtip2'.$this->minify.'.js',	array('qtip', "ithoughts_aliases"), "2.4.0" );
			...
			wp_register_script( 'ithoughts_tooltip_glossary-atoz',  $this->base_url . '/js/ithoughts_tt_gl-atoz'.$this->minify.'.js',  array('jquery', "ithoughts_aliases"), "2.4.0" );
			wp_register_script( 'ithoughts_tooltip_glossary-list',  $this->base_url . '/js/ithoughts_tt_gl-glossary-list'.$this->minify.'.js',  array('jquery', "ithoughts_aliases", "masonry"), "2.5.0" );
	 ...
	 */
		...
		public function searchTerms($args){
			...
			if ( function_exists('icl_object_id') ) {
				...
				var_dump($notTranslated,$postIds);
