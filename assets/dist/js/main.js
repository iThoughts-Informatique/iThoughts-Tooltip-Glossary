...
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', './comon', './optarray'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('./comon'), require('./optarray'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.comon, global.optarray);
		global.main = mod.exports;
	}
})(this, function (module, comon, OptArray) {
	/**
