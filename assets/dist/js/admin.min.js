/*! ithoughts-tooltip-glossary build on 2017-12-24 12:38:41 for v3.0.2 */
!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);var j=new Error("Cannot find module '"+g+"'");throw j.code="MODULE_NOT_FOUND",j}var k=c[g]={exports:{}};b[g][0].call(k.exports,function(a){var c=b[g][1][a];return e(c||a)},k,k.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b,c){!function(b,d){if("function"==typeof define&&define.amd)define(["./floater","./comon"],d);else if(void 0!==c)d(a("./floater"),a("./comon"));else{var e={exports:{}};d(b.floater,b.comon),b.admin=e.exports}}(this,function(a,b){/**
  ...
  * @version 2.7.0
  */
"use strict";function c(a){return function(){var b=a.apply(this,arguments);return new Promise(function(a,c){function d(e,f){try{var g=b[e](f),h=g.value}catch(a){return void c(a)}if(!g.done)return Promise.resolve(h).then(function(a){d("next",a)},function(a){d("throw",a)});a(h)}return d("next")})}}var d=iThoughts.v5,e=d.$,f=d.$d,g=iThoughtsTooltipGlossary;g.updateStyle=function(a,b,c){var d=["qtip-"+b];!0===a?d=d.concat(["ithoughts_tt_gl-tooltip","qtip-pos-br"]):void 0!==a&&a&&"Array"===a.constructor.name&&(d=d.concat(a)),c.qtip("option","style.classes",d.join(" "))},f.ready(a).ready(function(){var a=e("#qtip-exampleStyle");a.qtip("api").show();var f="change blur keyup mouseup",h=e("#tip-style"),i=e("#tip-shadow"),j=e("#tip-rounded");d.$merge(h,i,j).bind(f,function(){var b=["ithoughts_tt_gl-tooltip","qtip-pos-br"];i.is(":checked")&&b.push("qtip-shadow"),j.is(":checked")&&b.push("qtip-rounded"),g.updateStyle(b,h.val(),a)});var k=e("#tip-trigger"),l=e("#tip-anim-in"),m=e("#tip-anim-out"),n=e("#tip-anim-time");d.$merge(k,l,m,n).bind(f,function(){var b=k.val();try{a.qtip("option","show.event",b).qtip("option","hide.event","responsive"===b?"responsiveout":"mouseleave").qtip("option","show.effect",g.animationFunctions.in[l.val()]).qtip("option","hide.effect",g.animationFunctions.out[m.val()]).prop("animation_duration",parseInt(n.val()||500))}catch(a){g.error(a)}}),e("#itg-purge").click(c(regeneratorRuntime.mark(function a(){return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:return a.prev=0,a.next=3,b.sendAjaxQuery("purge_logs",null,e("#_wpnonce").val());case 3:a.next=8;break;case 5:a.prev=5,a.t0=a.catch(0),g.growl("AJAX request error",a.t0.statusText,!1);case 8:case"end":return a.stop()}},a,void 0,[[0,5]])})));var o=e("#verbosity"),p=e("#ithoughts_tt_gl-verbosity_label"),q=p.data("labels");o.on("input",function(){p.text(q[o.val()])}).trigger("input");var r=e("#glossary-index");r.bind(f.replace("blur","").replace("mouseup",""),function(){"new"===r.val()&&g.indexPageEditor&&(r.focusout(),g.indexPageEditor())})})})},{"./comon":2,"./floater":3}],2:[function(a,b,c){!function(d,e){if("function"==typeof define&&define.amd)define(["module","regenerator-runtime/runtime"],e);else if(void 0!==c)e(b,a("regenerator-runtime/runtime"));else{var f={exports:{}};e(f,d.runtime),d.comon=f.exports}}(this,function(a){"use strict";var b=iThoughts.v5,c=b.$,d=b.isNA,e=iThoughtsTooltipGlossary,f=["href","title"],g=function(a){return f.includes(a)||a.startsWith("data-")?a:"data-"+a},h=function(a){var b={};return Array.prototype.slice.call(a.attributes,0).forEach(function(a){b[a.nodeName]=a.nodeValue}),b},i=function(a){return a.tagName&&(a=h(a)),function(b,c){if(arguments.length>2&&void 0!==arguments[2]&&arguments[2]||(b=g(b)),a.hasOwnProperty(b)){var d=a[b];return delete a[b],d}return c}},j=function(a,b,c){var d=!1;return b.forEach(function(b){void 0!==a&&a.hasOwnProperty(b)?a=a[b]:d=!0}),d?c:a},k=function(a){return"string"==typeof a&&("1"===a||"true"===a.toLowerCase())||"number"==typeof a&&a>0},l=function(a){return c("<textarea />").text(a).html()},m=function(a){return c("<textarea />").html(a).text()},n=function(a,f,g){var h=b.makeLoader();return new Promise(function(b,i){var j={action:"ithoughts_tt_gl_"+a};d(g)||(j._wpnonce=g),d(f)||(j.data=f),c.ajax({method:"POST",async:!0,url:e.admin_ajax,data:j,success:function(a){return h.remove(),b(a)},error:function(a){return h.remove(),e.error("Error while doing XHR request:",a),i(a)}})})};a.exports={maybePrefixAttribute:g,extractAttrs:h,generateTakeAttr:i,get:j,isTrueValue:k,htmlEncode:l,htmlDecode:m,sendAjaxQuery:n}})},{"regenerator-runtime/runtime":4}],3:[function(a,b,c){(function(a){!function(a,d){if("function"==typeof define&&define.amd)define(["module"],d);else if(void 0!==c)d(b);else{var e={exports:{}};d(e),a.floater=e.exports}}(this,function(b){/**
