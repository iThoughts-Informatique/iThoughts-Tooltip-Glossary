...
function _asyncToGenerator(a){return function(){var b=a.apply(this,arguments);return new Promise(function(a,c){function d(e,f){try{var g=b[e](f),h=g.value}catch(a){return void c(a)}if(!g.done)return Promise.resolve(h).then(function(a){d("next",a)},function(a){d("throw",a)});a(h)}return d("next")})}}var _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);var j=new Error("Cannot find module '"+g+"'");throw j.code="MODULE_NOT_FOUND",j}var k=c[g]={exports:{}};b[g][0].call(k.exports,function(a){var c=b[g][1][a];return e(c||a)},k,k.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b,c){/**
     ...
     * @version 2.7.0
     */
"use strict";var d=this,e=a("./floater"),f=a("./comon"),g=iThoughts.v5,h=g.$,i=g.$d,j=iThoughtsTooltipGlossary;j.updateStyle=function(a,b,c){var d=["qtip-"+b];!0===a?d=d.concat(["ithoughts_tt_gl-tooltip","qtip-pos-br"]):void 0!==a&&a&&"Array"===a.constructor.name&&(d=d.concat(a)),c.qtip("option","style.classes",d.join(" "))},i.ready(e).ready(function(){var a=h("#qtip-exampleStyle");a.qtip("api").show();var b="change blur keyup mouseup",c=h("#tip-style"),e=h("#tip-shadow"),i=h("#tip-rounded");g.$merge(c,e,i).bind(b,function(){var b=["ithoughts_tt_gl-tooltip","qtip-pos-br"];e.is(":checked")&&b.push("qtip-shadow"),i.is(":checked")&&b.push("qtip-rounded"),j.updateStyle(b,c.val(),a)});var k=h("#tip-trigger"),l=h("#tip-anim-in"),m=h("#tip-anim-out"),n=h("#tip-anim-time");g.$merge(k,l,m,n).bind(b,function(){var b=k.val();try{a.qtip("option","show.event",b).qtip("option","hide.event","responsive"===b?"responsiveout":"mouseleave").qtip("option","show.effect",j.animationFunctions.in[l.val()]).qtip("option","hide.effect",j.animationFunctions.out[m.val()]).prop("animation_duration",parseInt(n.val()||500))}catch(a){j.error(a)}}),h("#itg-purge").click(_asyncToGenerator(regeneratorRuntime.mark(function a(){return regeneratorRuntime.wrap(function(a){for(;;)switch(a.prev=a.next){case 0:return a.prev=0,a.next=3,f.sendAjaxQuery("purge_logs",null,h("#_wpnonce").val());case 3:a.next=8;break;case 5:a.prev=5,a.t0=a.catch(0),j.growl("AJAX request error",a.t0.statusText,!1);case 8:case"end":return a.stop()}},a,d,[[0,5]])})));var o=h("#verbosity"),p=h("#ithoughts_tt_gl-verbosity_label"),q=p.data("labels");o.on("input",function(){p.text(q[o.val()])}).trigger("input");var r=h("#glossary-index");r.bind(b.replace("blur","").replace("mouseup",""),function(){"new"===r.val()&&j.indexPageEditor&&(r.focusout(),j.indexPageEditor())})})},{"./comon":2,"./floater":3}],2:[function(a,b,c){"use strict";a("regenerator-runtime/runtime");var d=iThoughts.v5,e=d.$,f=d.isNA,g=iThoughtsTooltipGlossary,h=["href","title"],i=function(a){return h.includes(a)||a.startsWith("data-")?a:"data-"+a},j=function(a){var b={};return Array.prototype.slice.call(a.attributes,0).forEach(function(a){b[a.nodeName]=a.nodeValue}),b},k=function(a){return a.tagName&&(a=j(a)),function(b,c){if(arguments.length>2&&void 0!==arguments[2]&&arguments[2]||(b=i(b)),a.hasOwnProperty(b)){var d=a[b];return delete a[b],d}return c}},l=function(a,b,c){var d=!1;return b.forEach(function(b){void 0!==a&&a.hasOwnProperty(b)?a=a[b]:d=!0}),d?c:a},m=function(a){return"string"==typeof a&&("1"===a||"true"===a.toLowerCase())||"number"==typeof a&&a>0},n=function(a){return e("<textarea />").text(a).html()},o=function(a){return e("<textarea />").html(a).text()},p=function(a,b,c){var h=d.makeLoader();return new Promise(function(d,i){var j={action:"ithoughts_tt_gl_"+a};f(c)||(j._wpnonce=c),f(b)||(j.data=b),e.ajax({method:"POST",async:!0,url:g.admin_ajax,data:j,success:function(a){return h.remove(),d(a)},error:function(a){return h.remove(),g.error("Error while doing XHR request:",a),i(a)}})})};b.exports={maybePrefixAttribute:i,extractAttrs:j,generateTakeAttr:k,get:l,isTrueValue:m,htmlEncode:n,htmlDecode:o,sendAjaxQuery:p}},{"regenerator-runtime/runtime":4}],3:[function(a,b,c){(function(a){/**
