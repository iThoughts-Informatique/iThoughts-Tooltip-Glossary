...
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['./floater', './comon'], factory);
	} else if (typeof exports !== "undefined") {
		factory(require('./floater'), require('./comon'));
	} else {
		var mod = {
			exports: {}
		};
		factory(global.floater, global.comon);
		global.admin = mod.exports;
	}
})(this, function (initFloater, comon) {
	/**
  ...
  */
	...
	$d.ready(initFloater).ready(function () {
		// #### Get some DOMs
...
},{"regenerator-runtime/runtime":4}],3:[function(require,module,exports){
(function (global){
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
  ...
  */
	...
	var initFloater = function initFloater() {
