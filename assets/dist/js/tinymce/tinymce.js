...
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', 'regenerator-runtime/runtime'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('regenerator-runtime/runtime'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.runtime);
		global.comon = mod.exports;
	}
...
(function (global, factory) {
  ...
  */
	...
	var initTinymceEditors = function initTinymceEditors($editors) {
	...
	var OptArray = function () {
		...
		_createClass(OptArray, [{
			...
			value: function toString() {
				...
				return Object.keys(this.opts).sort().map(function (key) {
...
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', './tinymce-utils', './tinymce-filters', '../dom-utils'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('./tinymce-utils'), require('./tinymce-filters'), require('../dom-utils'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.tinymceUtils, global.tinymceFilters, global.domUtils);
		global.formHandler = mod.exports;
	}
})(this, function (module, utils, filters, domUtils) {
	/**
  ...
  */
	...
	module.exports = function (formDom) {
		var $formDom = $(formDom);
		var formType = '';
		...
		if ('TIP' === formType) {
			(function initTipForm() {
				...
				domUtils.initTab($('#ithoughts_tt_gl-tooltip-form .tabs li'), function (index) {
...
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', '../optarray', './tinymce-utils', '../comon'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('../optarray'), require('./tinymce-utils'), require('../comon'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.optarray, global.tinymceUtils, global.comon);
		global.tinymceFilters = mod.exports;
	}
})(this, function (module, OptArray, utils, comon) {
	'use strict';
	...
	var maybePrefixOpt = function maybePrefixOpt(opt) {
		return function (match) {
			var key = comon.maybePrefixAttribute([match[1], match[2]].filter(function (v) {
				return v;
			}).join(''));
			var value = match[3];
			if ('data-type' === key) {
	...
	module.exports = {
		...
		restore: {
			tip: function tip(content) {
				// For [itg-gloss]
				return content.replace(/<a\s+(?=[^>]*data-type="itg-(gloss|tooltip|mediatip)")(.*?)>(.*?)<\/a>/g, function (all, type, inner, text) {
					var attrs = new OptArray();
					var tag = 'itg-' + type;
					attributesToOpts(attrs, inner);
			...
			list: function list(content) {
				// For [glossary_(term_list|atoz)]
				return content.replace(/<span\s+(?=[^>]*data-type="itg-(glossary|atoz)")(.*?)>.*?<\/span>/g, function (all, type, inner) {
					var attrs = new OptArray();
					var tag = 'itg-' + type;
					attributesToOpts(attrs, inner);
...
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', './tinymce-utils', './tinymce-filters', './form-handler'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('./tinymce-utils'), require('./tinymce-filters'), require('./form-handler'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.tinymceUtils, global.tinymceFilters, global.formHandler);
		global.tinymcePlugin = mod.exports;
	}
})(this, function (module, utils, filters, formHandler) {
	/**
  ...
  */
	...
	var tinyMcePlugin = {
		...
		replaceShortcodesEl: [filters.replace.tip, filters.replace.list],
		restoreShortcodesEl: [filters.restore.tip, filters.restore.list]
	};

	$.extend(itge, tinyMcePlugin);

	tinyMcePlugin.buttonActions = {
		replaceWithInnerHtml: function replaceWithInnerHtml(editor) {
		...
		insertInTinyMCE: function insertInTinyMCE(editor, shortcode, mode) {
		...
		doForm: function () {
			var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(editor, mode, tinyMceTarget) {
				var result;
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							case 0:
								_context.next = 2;
								return utils.editorForms[mode](utils.generateSelObject(editor));
...
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(['module', 'remove-accents', '../optarray', '../comon'], factory);
	} else if (typeof exports !== "undefined") {
		factory(module, require('remove-accents'), require('../optarray'), require('../comon'));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod, global.removeAccents, global.optarray, global.comon);
		global.tinymceUtils = mod.exports;
	}
})(this, function (module, removeAccents, OptArray, comon) {
	'use strict';
